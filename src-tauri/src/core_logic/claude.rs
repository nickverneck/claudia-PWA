[File content truncated: showing lines 1-2000 of 2159 total lines. Use offset/limit parameters to view more.]
...
fn create_command_with_env(program: &str) -> Command {
    ...
    let _std_cmd = claude_binary::create_command_with_env(program);
...
pub fn create_project(path: String) -> Result<Project, String> {
...
pub fn get_project_sessions(project_id: String) -> Result<Vec<Session>, String> {
...
pub fn open_new_session(app: &AppHandle, path: Option<String>) -> Result<String, String> {
    ...
    #[cfg(debug_assertions)]
    {
        let mut std::process::Command::new(claude_path);
...
pub fn check_claude_version(app: &AppHandle) -> Result<ClaudeVersionStatus, String> {
...
pub fn save_system_prompt(content: String) -> Result<String, String> {
...
pub fn save_claude_settings(settings: serde_json::Value) -> Result<String, String> {
...
pub fn find_claude_md_files(project_path: String) -> Result<Vec<ClaudeMdFile>, String> {
...
pub fn read_claude_md_file(file_path: String) -> Result<String, String> {
...
pub fn save_claude_md_file(file_path: String, content: String) -> Result<String, String> {
...
pub fn list_running_claude_sessions(
    registry: tauri::State<'_, process::ProcessRegistryState>,
) -> Result<Vec<process::ProcessInfo>, String> {
    registry.0.get_running_claude_sessions()
}

pub fn get_claude_session_output(
    registry: tauri::State<'_, process::ProcessRegistryState>,
    session_id: String,
...
async fn spawn_claude_process(app: AppHandle, mut cmd: Command, prompt: String, model: String, project_path: String) -> Result<(), String> {
    ...
    let registry = app.state::<process::ProcessRegistryState>();
...
pub fn list_directory_contents(directory_path: String) -> Result<Vec<FileEntry>, String> {
...
pub fn search_files(base_path: String, query: String) -> Result<Vec<FileEntry>, String> {
