...
fn create_command_with_env(program: &str) -> Command {
    claude_binary::create_command_with_env(program)
}

/// Finds the full path to the claude binary
/// This is necessary because macOS apps have a limited PATH environment
fn find_claude_binary(app_handle: &AppHandle) -> Result<String> {
    claude_binary::find_claude_binary(app_handle).map_err(|e| anyhow::anyhow!(e))
}
...
pub fn list_servers(app: &AppHandle) -> Result<Vec<MCPServer>, String> {
...
pub fn get_server(app: &AppHandle, name: String) -> Result<MCPServer, String> {
...
pub fn remove_server(app: &AppHandle, name: String) -> Result<String, String> {
...
pub async fn add_server_from_claude_desktop(
    app: AppHandle,
    scope: String,
    ...
    for (name, server_config) in mcp_servers {
        ...
        match add_server_from_json(&app, name.clone(), json_str, scope.clone()) {
            Ok(result) => {
                if result.success {
                    imported_count += 1;
                    server_results.push(ImportServerResult {
...
pub fn test_connection(app: &AppHandle, name: String) -> Result<String, String> {
...
pub fn reset_project_choices(app: &AppHandle) -> Result<String, String> {
...
pub fn get_server_status() -> Result<HashMap<String, ServerStatus>, String> {
...
pub fn read_project_config(project_path: String) -> Result<MCPProjectConfig, String> {
