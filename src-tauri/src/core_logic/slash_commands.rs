...
pub fn get_command(command_id: String) -> Result<SlashCommand, String> {
    ...
    let commands = list_commands(None)?;
...
pub fn delete_command(command_id: String, project_path: Option<String>) -> Result<String, String> {
    ...
    let commands = list_commands(project_path)?;
