...
use commands::agents::{
    ...
    get_codex_binary_path, get_gemini_binary_path, get_live_session_output,
    get_primary_cli_provider, get_qwen_binary_path, get_session_output, get_session_status, import_agent,
    import_agent_from_file, import_agent_from_github, init_database, kill_agent_session,
    list_agent_runs, list_agent_runs_with_metrics, list_agents, list_claude_installations,
    list_codex_installations, list_gemini_installations, list_qwen_installations,
    list_running_sessions, load_agent_session_history, set_claude_binary_path,
    set_codex_binary_path, set_gemini_binary_path, set_primary_cli_provider, set_qwen_binary_path,
...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            list_gemini_installations,
            get_primary_cli_provider,
            set_primary_cli_provider,
            get_qwen_binary_path,
            set_qwen_binary_path,
            list_qwen_installations,
            export_agent,
