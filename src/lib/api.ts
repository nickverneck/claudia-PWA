...
export const api = {
  ...
  async getHomeDirectory(): Promise<string> {
    try {
      return await callApi<string>("get_home_directory");
    } catch (error) {
  ...
  async listProjects(): Promise<Project[]> {
    try {
      return await callApi<Project[]>("list_projects");
    } catch (error) {
  ...
  async createProject(path: string): Promise<Project> {
    try {
      return await callApi<Project>('create_project', { path });
    } catch (error) {
  ...
  async getProjectSessions(projectId: string): Promise<Session[]> {
    try {
      return await callApi<Session[]>('get_project_sessions', { projectId });
    } catch (error) {
  ...
  async fetchGitHubAgents(): Promise<GitHubAgentFile[]> {
    try {
      return await callApi<GitHubAgentFile[]>('fetch_github_agents');
    } catch (error) {
  ...
  async fetchGitHubAgentContent(downloadUrl: string): Promise<AgentExport> {
    try {
      return await callApi<AgentExport>('fetch_github_agent_content', { downloadUrl });
    } catch (error) {
  ...
  async importAgentFromGitHub(downloadUrl: string): Promise<Agent> {
    try {
      return await callApi<Agent>('import_agent_from_github', { downloadUrl });
    } catch (error) {
  ...
  async getClaudeSettings(): Promise<ClaudeSettings> {
    try {
      const result = await callApi<{ data: ClaudeSettings }>("get_claude_settings");
  ...
  async openNewSession(path?: string): Promise<string> {
    try {
      return await callApi<string>("open_new_session", { path });
    } catch (error) {
  ...
  async getSystemPrompt(): Promise<string> {
    try {
      return await callApi<string>("get_system_prompt");
    } catch (error) {
  ...
  async checkClaudeVersion(): Promise<ClaudeVersionStatus> {
    try {
      return await callApi<ClaudeVersionStatus>("check_claude_version");
    } catch (error) {
  ...
  async saveSystemPrompt(content: string): Promise<string> {
    try {
      return await callApi<string>("save_system_prompt", { content });
    } catch (error) {
  ...
  async saveClaudeSettings(settings: ClaudeSettings): Promise<string> {
    try {
      return await callApi<string>("save_claude_settings", { settings });
    } catch (error) {
  ...
  async findClaudeMdFiles(projectPath: string): Promise<ClaudeMdFile[]> {
    try {
      return await callApi<ClaudeMdFile[]>("find_claude_md_files", { projectPath });
    } catch (error) {
  ...
  async readClaudeMdFile(filePath: string): Promise<string> {
    try {
      return await callApi<string>("read_claude_md_file", { filePath });
    } catch (error) {
  ...
  async saveClaudeMdFile(filePath: string, content: string): Promise<string> {
    try {
      return await callApi<string>("save_claude_md_file", { filePath, content });
    } catch (error) {
  ...
  async listAgents(): Promise<Agent[]> {
    try {
      return await callApi<Agent[]>('list_agents');
    } catch (error) {
  ...
  async createAgent(
    ...
    try {
      return await callApi<Agent>('create_agent', { 
        name, 
        icon, 
  ...
  async updateAgent(
    ...
    try {
      return await callApi<Agent>('update_agent', { 
        id, 
        name, 
        icon, 
        systemPrompt: system_prompt,
  ...
  async getAgent(id: number): Promise<Agent> {
    try {
      return await callApi<Agent>('get_agent', { id });
    } catch (error) {
  ...
  async exportAgent(id: number): Promise<string> {
    try {
      return await callApi<string>('export_agent', { id });
    } catch (error) {
  ...
  async importAgent(jsonData: string): Promise<Agent> {
    try {
      return await callApi<Agent>('import_agent', { jsonData });
    } catch (error) {
  ...
  async importAgentFromFile(filePath: string): Promise<Agent> {
    try {
      return await callApi<Agent>('import_agent_from_file', { filePath });
    } catch (error) {
  ...
  async executeAgent(agentId: number, projectPath: string, task: string, model?: string): Promise<number> {
    try {
      return await callApi<number>('execute_agent', { agentId, projectPath, task, model });
    } catch (error) {
  ...
  async listAgentRuns(agentId?: number): Promise<AgentRunWithMetrics[]> {
    try {
      return await callApi<AgentRunWithMetrics[]>('list_agent_runs', { agentId });
    } catch (error) {
  ...
  async listAgentRunsWithMetrics(agentId?: number): Promise<AgentRunWithMetrics[]> {
    try {
      return await callApi<AgentRunWithMetrics[]>('list_agent_runs_with_metrics', { agentId });
    } catch (error) {
  ...
  async getAgentRun(id: number): Promise<AgentRunWithMetrics> {
    try {
      return await callApi<AgentRunWithMetrics>('get_agent_run', { id });
    } catch (error) {
  ...
  async getAgentRunWithRealTimeMetrics(id: number): Promise<AgentRunWithMetrics> {
    try {
      return await callApi<AgentRunWithMetrics>('get_agent_run_with_real_time_metrics', { id });
    } catch (error) {
  ...
  async listRunningAgentSessions(): Promise<AgentRun[]> {
    try {
      return await callApi<AgentRun[]>('list_running_sessions');
    } catch (error) {
  ...
  async killAgentSession(runId: number): Promise<boolean> {
    try {
      return await callApi<boolean>('kill_agent_session', { runId });
    } catch (error) {
  ...
  async getSessionStatus(runId: number): Promise<string | null> {
    try {
      return await callApi<string | null>('get_session_status', { runId });
    } catch (error) {
  ...
  async cleanupFinishedProcesses(): Promise<number[]> {
    try {
      return await callApi<number[]>('cleanup_finished_processes');
    } catch (error) {
  ...
  async getSessionOutput(runId: number): Promise<string> {
    try {
      return await callApi<string>('get_session_output', { runId });
    } catch (error) {
  ...
  async getLiveSessionOutput(runId: number): Promise<string> {
    try {
      return await callApi<string>('get_live_session_output', { runId });
    } catch (error) {
  ...
  async streamSessionOutput(runId: number): Promise<void> {
    try {
      return await callApi<void>('stream_session_output', { runId });
    } catch (error) {
  ...
  async loadAgentSessionHistory(sessionId: string): Promise<any[]> {
    try {
      return await callApi<any[]>('load_agent_session_history', { sessionId });
    } catch (error) {
  ...
  async getUsageStats(): Promise<UsageStats> {
    try {
      return await callApi<UsageStats>("get_usage_stats");
    } catch (error) {
  ...
  async getUsageByDateRange(startDate: string, endDate: string): Promise<UsageStats> {
    try {
      return await callApi<UsageStats>("get_usage_by_date_range", { startDate, endDate });
    } catch (error) {
  ...
  async getSessionStats(
    ...
    try {
      return await callApi<ProjectUsage[]>("get_session_stats", {
        since,
        until,
        order,
      });
  ...
  async getUsageDetails(limit?: number): Promise<UsageEntry[]> {
    try {
      return await callApi<UsageEntry[]>("get_usage_details", { limit });
    } catch (error) {
  ...
  async getCheckpointDiff(
    ...
    try {
      return await callApi<CheckpointDiff>("get_checkpoint_diff", {
        fromCheckpointId,
        toCheckpointId,
        sessionId,
        projectId
  ...
  async checkAutoCheckpoint(
    ...
    try {
      return await callApi<boolean>("check_auto_checkpoint", {
        sessionId,
        projectId,
        projectPath,
        message
  ...
  async cleanupOldCheckpoints(
    ...
    try {
      return await callApi<number>("cleanup_old_checkpoints", {
        sessionId,
        projectId,
        projectPath,
        keepCount
  ...
  async mcpAdd(
    ...
    try {
      return await callApi<AddServerResult>("mcp_add", {
        name,
        transport,
        command,
        args,
  ...
  async mcpList(): Promise<MCPServer[]> {
    try {
      ...
      const result = await callApi<MCPServer[]>("mcp_list");
  ...
  async mcpGet(name: string): Promise<MCPServer> {
    try {
      return await callApi<MCPServer>("mcp_get", { name });
    } catch (error) {
  ...
  async mcpRemove(name: string): Promise<string> {
    try {
      return await callApi<string>("mcp_remove", { name });
    } catch (error) {
  ...
  async mcpAddJson(name: string, jsonConfig: string, scope: string = "local"): Promise<AddServerResult> {
    try {
      return await callApi<AddServerResult>("mcp_add_json", { name, jsonConfig, scope });
    } catch (error) {
  ...
  async mcpAddFromClaudeDesktop(scope: string = "local"): Promise<ImportResult> {
    try {
      return await callApi<ImportResult>("mcp_add_from_claude_desktop", { scope });
    } catch (error) {
  ...
  async mcpServe(): Promise<string> {
    try {
      return await callApi<string>("mcp_serve");
    } catch (error) {
  ...
  async mcpTestConnection(name: string): Promise<string> {
    try {
      return await callApi<string>("mcp_test_connection", { name });
    } catch (error) {
  ...
  async mcpResetProjectChoices(): Promise<string> {
    try {
      return await callApi<string>("mcp_reset_project_choices");
    } catch (error) {
  ...
  async mcpGetServerStatus(): Promise<Record<string, ServerStatus>> {
    try {
      return await callApi<Record<string, ServerStatus>>("mcp_get_server_status");
    } catch (error) {
  ...
  async mcpReadProjectConfig(projectPath: string): Promise<MCPProjectConfig> {
    try {
      return await callApi<MCPProjectConfig>("mcp_read_project_config", { projectPath });
    } catch (error) {
  ...
  async mcpSaveProjectConfig(projectPath: string, config: MCPProjectConfig): Promise<string> {
    try {
      return await callApi<string>("mcp_save_project_config", { projectPath, config });
    } catch (error) {
  ...
  async getClaudeBinaryPath(): Promise<string | null> {
    try {
      return await callApi<string | null>("get_claude_binary_path");
    } catch (error) {
  ...
  async setClaudeBinaryPath(path: string): Promise<void> {
    try {
      return await callApi<void>("set_claude_binary_path", { path });
    } catch (error) {
  ...
  async listClaudeInstallations(): Promise<ClaudeInstallation[]> {
    try {
      return await callApi<ClaudeInstallation[]>("list_claude_installations");
    } catch (error) {
  ...
  async storageListTables(): Promise<any[]> {
    try {
      return await callApi<any[]>("storage_list_tables");
    } catch (error) {
  ...
  async storageReadTable(
    ...
    try {
      return await callApi<any>("storage_read_table", {
        tableName,
        page,
        pageSize,
        searchQuery,
  ...
  async storageUpdateRow(
    ...
    try {
      return await callApi<void>("storage_update_row", {
        tableName,
        primaryKeyValues,
        updates,
      });
  ...
  async storageDeleteRow(
    ...
    try {
      return await callApi<void>("storage_delete_row", {
        tableName,
        primaryKeyValues,
      });
    } catch (error) {
  ...
  async storageInsertRow(
    ...
    try {
      return await callApi<number>("storage_insert_row", {
        tableName,
        values,
      });
    } catch (error) {
  ...
  async storageExecuteSql(query: string): Promise<any> {
    try {
      return await callApi<any>("storage_execute_sql", { query });
    } catch (error) {
  ...
  async storageResetDatabase(): Promise<void> {
    try {
      return await callApi<void>("storage_reset_database");
    } catch (error) {
  ...
  async getHooksConfig(scope: 'user' | 'project' | 'local', projectPath?: string): Promise<HooksConfiguration> {
    try {
      return await callApi<HooksConfiguration>("get_hooks_config", { scope, projectPath });
    } catch (error) {
  ...
  async updateHooksConfig(
    ...
    try {
      return await callApi<string>("update_hooks_config", { scope, projectPath, hooks });
    } catch (error) {
  ...
  async validateHookCommand(command: string): Promise<{ valid: boolean; message: string }> {
    try {
      return await callApi<{ valid: boolean; message: string }>("validate_hook_command", { command });
    } catch (error) {
  ...
  async slashCommandsList(projectPath?: string): Promise<SlashCommand[]> {
    try {
      return await callApi<SlashCommand[]>("slash_commands_list", { projectPath });
    } catch (error) {
  ...
  async slashCommandGet(commandId: string): Promise<SlashCommand> {
    try {
      return await callApi<SlashCommand>("slash_command_get", { commandId });
    } catch (error) {
  ...
  async slashCommandSave(
    ...
    try {
      return await callApi<SlashCommand>("slash_command_save", {
        scope,
        name,
        namespace,
        content,
  ...
  async slashCommandDelete(commandId: string, projectPath?: string): Promise<string> {
    try {
      return await callApi<string>("slash_command_delete", { commandId, projectPath });
    } catch (error) {
